...
class WebViewLoadingModel {
  String? title;
  String? url;
  WebViewLoadingModel({this.title, this.url});
}

class WebViewLoadingWidgetPage extends StatefulWidget {
  WebViewLoadingWidgetPage({Key? key, this.title, this.url}) : super(key: key);
  String? title;
  String? url;
  @override
  State<WebViewLoadingWidgetPage> createState() => _WebViewLoadingWidgetPageState();
}

class _WebViewLoadingWidgetPageState extends State<WebViewLoadingWidgetPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: kDebugMode ? favoriteButton() : null,
    );
  }
    ...
    return FloatingActionButton(
      onPressed: () async {
        ...
        ScaffoldMessenger.of(Get.context!).showSnackBar(
          SnackBar(content: Text('Current URL:\n$url')),
        );
      },
