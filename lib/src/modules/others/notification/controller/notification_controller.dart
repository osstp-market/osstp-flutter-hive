...
/// awesome_notification controller
///
class NotificationsController {
  ...
  static Future<void> onNotificationCreatedMethod(ReceivedNotification receivedNotification) async {
    ...
    Fluttertoast.showToast(
        msg: message, toastLength: Toast.LENGTH_SHORT, backgroundColor: Colors.green, gravity: ToastGravity.BOTTOM);
  }
  ...
  static Future<void> onNotificationDisplayedMethod(ReceivedNotification receivedNotification) async {
    ...
    print(message2);
    Fluttertoast.showToast(
        msg: message1, toastLength: Toast.LENGTH_SHORT, backgroundColor: Colors.blue, gravity: ToastGravity.BOTTOM);
  }
  ...
  static Future<void> onDismissActionReceivedMethod(ReceivedAction receivedAction) async {
    ...
    Fluttertoast.showToast(
        msg: message, toastLength: Toast.LENGTH_SHORT, backgroundColor: Colors.orange, gravity: ToastGravity.BOTTOM);
  }
  ...
  static Future<void> onActionReceivedMethodImpl(ReceivedAction receivedAction) async {
    ...
    if (receivedAction.actionType != ActionType.SilentBackgroundAction) {
      Fluttertoast.showToast(
          ...
          backgroundColor: isSilentAction ? Colors.blueAccent : Colors.cyan,
  ...
  static Future<void> receiveStandardNotificationAction(ReceivedAction receivedAction) async {
    loadSingletonPage(globalNavigatorKey.currentState,
        targetPage: Routers.notificationDetailPage, receivedAction: receivedAction);
  }
  ...
  static Future<void> receiveMediaNotificationAction(ReceivedAction receivedAction) async {
    switch (receivedAction.buttonKeyPressed) {
      ...
      default:
        loadSingletonPage(globalNavigatorKey.currentState,
            targetPage: Routers.mediaDetailsPage, receivedAction: receivedAction);
        break;
    }
  }
  ...
  static Future<void> receiveAlarmNotificationAction(ReceivedAction receivedAction) async {
  ...
  static Future<void> receiveCallNotificationAction(ReceivedAction receivedAction) async {
    switch (receivedAction.buttonKeyPressed) {
      case 'REJECT':
      ...
      case 'ACCEPT':
        loadSingletonPage(globalNavigatorKey.currentState,
            targetPage: Routers.phoneCallPage, receivedAction: receivedAction);
        break;
