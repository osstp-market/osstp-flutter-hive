...
class MediaDetailsPageState extends State<MediaDetailsPage> {
    ...
    MediaPlayerCentral.mediaStream.listen((media) {
      switch (MediaPlayerCentral.mediaLifeCycle) {
        ...
        case MediaLifeCycle.paused:
          ...
          //     100, media, durationPlayed ?? Duration.zero, NotificationPlayState.paused);
          NotificationUtils.updateNotificationMediaPlayer(100, media, durationPlayed ?? Duration.zero);
          break;

        case MediaLifeCycle.playing:
          // NotificationUtils.updateNotificationMediaPlayer(
          //     100, media, durationPlayed ?? Duration.zero, NotificationPlayState.playing);
          NotificationUtils.updateNotificationMediaPlayer(100, media, durationPlayed ?? Duration.zero);
          break;
      }
    });
  ...
  Widget mediaCloseCaption(
    ...
    TextStyle? textStyle = themeData.textTheme.titleLarge?.copyWith(color: contrastColor);
