...
class ParallaxContainer extends StatelessWidget {
  ...
  const ParallaxContainer(
      {Key? key, required this.child, required this.position, this.translationFactor = 100.0, this.opacityFactor = 1.0})
...
class ParallaxImage extends StatelessWidget {
  ...
  ParallaxImage.asset(String name, {Key? key, required double position, this.imageFactor = 0.3})
